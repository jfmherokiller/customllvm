...
cmake -GNinja -DCMAKE_INSTALL_PREFIX=$INSTALLDIR -DLLVM_CCACHE_BUILD=ON -DLLVM_EXPERIMENTAL_TARGETS_TO_BUILD=ZCPU -DLLVM_TARGETS_TO_BUILD=X86 -DCMAKE_BUILD_TYPE=Release $WORKDIR/llvm
ninja install
