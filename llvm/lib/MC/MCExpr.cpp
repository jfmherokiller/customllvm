...
StringRef MCSymbolRefExpr::getVariantKindName(VariantKind Kind) {
  ...
  case VK_ZCPU_GPREL: return "GPREL";
  case VK_ZCPU_GOT_CALL: return "GOT_CALL";
  case VK_ZCPU_GOT16: return "GOT16";
  case VK_ZCPU_GOT: return "GOT";
  case VK_ZCPU_ABS_HI: return "ABS_HI";
  case VK_ZCPU_ABS_LO: return "ABS_LO";
  case VK_ZCPU_TLSGD: return "TLSGD";
  case VK_ZCPU_TLSLDM: return "TLSLDM";
  case VK_ZCPU_DTP_HI: return "DTP_HI";
  case VK_ZCPU_DTP_LO: return "DTP_LO";
  case VK_ZCPU_GOTTPREL: return "GOTTPREL";
  case VK_ZCPU_TP_HI: return "TP_HI";
  case VK_ZCPU_TP_LO: return "TP_LO";
  case VK_ZCPU_GPOFF_HI: return "GPOFF_HI";
  case VK_ZCPU_GPOFF_LO: return "GPOFF_LO";
  case VK_ZCPU_GOT_DISP: return "GOT_DISP";
  case VK_ZCPU_GOT_PAGE: return "GOT_PAGE";
  case VK_ZCPU_GOT_OFST: return "GOT_OFST";
  case VK_ZCPU_HIGHER:   return "HIGHER";
  case VK_ZCPU_HIGHEST:  return "HIGHEST";
  case VK_ZCPU_GOT_HI16: return "GOT_HI16";
  case VK_ZCPU_GOT_LO16: return "GOT_LO16";
  case VK_ZCPU_CALL_HI16: return "CALL_HI16";
  case VK_ZCPU_CALL_LO16: return "CALL_LO16";
