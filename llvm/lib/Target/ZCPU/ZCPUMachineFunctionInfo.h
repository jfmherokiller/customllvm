// ZCPUMachineFunctionInfo.h-ZCPU machine function info-*- C++ -*-
//
...
///
/// \file
/// \brief This file declares ZCPU-specific per-machine-function
/// information.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_ZCPU_ZCPUMACHINEFUNCTIONINFO_H
#define LLVM_LIB_TARGET_ZCPU_ZCPUMACHINEFUNCTIONINFO_H
...
/// ZCPU-specific information for each MachineFunction.
class ZCPUFunctionInfo final : public MachineFunctionInfo {
  MachineFunction &MF;

  std::vector<MVT> Params;

  /// A mapping from CodeGen vreg index to ZCPU register number.
 ...
 public:
  explicit ZCPUFunctionInfo(MachineFunction &MF) : MF(MF) {}
  ~ZCPUFunctionInfo() override;
