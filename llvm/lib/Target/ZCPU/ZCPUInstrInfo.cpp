...
//  {
//    // copy GR8 to GR8
//    //BuildMI(MBB, I, DL, get(ZCPU::LD8rr), DestReg).addReg(SrcReg, getKillRegState(KillSrc));
//    return;
//  }
...
bool ZCPUInstrInfo::AnalyzeBranch(MachineBasicBlock &MBB,MachineBasicBlock *&TBB, MachineBasicBlock *&FBB,SmallVectorImpl<MachineOperand> &Cond, bool AllowModify = false) const
{
