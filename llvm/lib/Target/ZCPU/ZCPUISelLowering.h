//===-- ZCPUISelLowering.h - X86 DAG Lowering Interface ----------*- C++ -*-===//
//
...
#ifndef ZCPUISELLOWERING_H
#define ZCPUISELLOWERING_H
...
namespace llvm {
  ...
  public:
    explicit ZCPUTargetLowering(ZCPUTargetMachine &TM);
  ...
  private:
    ...
    // equivalent ZCPU condition code.
    SDValue EmitCMP(SDValue &LHS, SDValue &RHS, SDValue &ZCPUCC,
      ISD::CondCode CC, SDLoc dl, SelectionDAG &DAG) const;
  }; // end class ZCPUTargetLowering
} // end namespace llvm
