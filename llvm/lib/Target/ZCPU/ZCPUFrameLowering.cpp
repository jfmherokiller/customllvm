...
const ZCPUFrameLowering *ZCPUFrameLowering::create(const ZCPUSubtarget &ST) {
  return llvm::createZCPUSEFrameLowering(ST);
}
...
eliminateCallFramePseudoInstr(MachineFunction &MF, MachineBasicBlock &MBB,
  ...
  if (!hasReservedCallFrame(MF)) {
    ...
    if (I->getOpcode() == ZCPU::ADJCALLSTACKDOWN)
      Amount = -Amount;
