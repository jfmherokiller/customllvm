...
///
/// \file
/// \brief This file implements the ZCPUMCCodeEmitter class.
///
//===----------------------------------------------------------------------===//
...
namespace {
class ZCPUMCCodeEmitter final : public MCCodeEmitter {
...
public:
  ZCPUMCCodeEmitter(const MCInstrInfo &mcii) : MCII(mcii) {}
};
} // end anonymous namespace

MCCodeEmitter *llvm::createZCPUMCCodeEmitter(const MCInstrInfo &MCII) {
  return new ZCPUMCCodeEmitter(MCII);
}

void ZCPUMCCodeEmitter::encodeInstruction(
